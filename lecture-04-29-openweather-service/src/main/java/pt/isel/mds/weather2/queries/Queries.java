...
import pt.isel.mds.weather2.queries.iterators.*;
...
public class Queries {
    ...
    Iterable<U> map(Iterable<T> src, Function<T, U> mapper) {
        //Supplier<Iterator<U>> res = () -> new MapIterator<>(src, mapper);
    ...
    public static <T>  Iterable<T> distinct(Iterable<T> src, Comparator<T> cmp){
