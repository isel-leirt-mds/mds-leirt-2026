...
import pt.isel.mds.weather_async.requests.*;
...
public class OpenWeatherWebApiAsync {
     ...
     * @return
     */
    public CompletableFuture<PollutionInfoDto> airPollutionAt(double lat, double lon) {
     ...
     * @return
     */
    public CompletableFuture<List<WeatherInfoForecastDto>> forecastWeatherAt(double lat, double lon) {
    ...
    public CompletableFuture<List<PollutionInfoDto>> pollutionHistoryAt(
